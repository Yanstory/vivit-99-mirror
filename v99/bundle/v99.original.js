...
, function(e, t, n) {
    ...
    function c(e) {
        ...
        return i.createElement("div", {
            ...
            className: "body"
        }, i.createElement("h2", null, t, "¡¡¤³¤ì¤Ï£¿¡¡", t), i.createElement("img", {
            className: "image",
            src: "./manual/v99ss.jpg"
        }), i.createElement("br", null), "?×î´ó99Ìå¤Î¥á©`¥É£¨¤Ê¤É£©¤ÈŒ‘é¤¹¤ëSTG", i.createElement("br", null), "£¨¡ù¥¹¥Þ©`¥È¥Õ¥©¥ó¤Ç¤ÏËû¥×¥ì¥¤¥ä©`¤Î±íÊ¾¤¬¤Ç¤­¤Þ¤»¤ó£©", i.createElement("br", null), i.createElement("br", null), "?CPU‘é¤Î¤ß¤ÇŒÈËŒ‘é¤Ï¤¢¤ê¤Þ¤»¤ó", i.createElement("br", null), "?¥×¥ì¥¤­h¾³¤Ë¤è¤Ã¤Æ¤Ï¤¹¤´¤¯ÖØ¤¤¤Î¤Ç¡¢¤Ä¤è¤Ä¤èPC¤Ç¤Î¥×¥ì¥¤¤òÍÆŠX", i.createElement("br", null), i.createElement("h2", null, t, "¡¡¥ë©`¥ë¡¡", t), "?Ëû¤Î¤¹¤Ù¤Æ¤Î¥×¥ì¥¤¥ä©`¤Î¥é¥¤¥Õ¤ò0¤Ë¤¹¤ë¤È„Ù¤Á", i.createElement("br", null), "?×Ô·Ö¤Î¥é¥¤¥Õ¤¬0¤Ë¤Ê¤ë¤ÈØ“¤±", i.createElement("br", null), i.createElement("br", null), "?”³Ž¤Ë¥«¥¹¤ë¤ÈËû¥×¥ì¥¤¥ä©`¤òÇàŽ¤Ç¹¥“Ä", i.createElement("br", null), "?ßB¾A¤·¤Æ¥«¥¹¤ë¤È¥³¥ó¥Ü¤¬‰ˆ¤¨¤ë", i.createElement("br", null), "?¥³¥ó¥Ü¤¬ÇÐ¤ì¤¿¥¿¥¤¥ß¥ó¥°¤ÇÇàÓñ¹¥“Ä¥ì¥Ù¥ëÉÏ•N", i.createElement("br", null), "?±»Ž¤Ç¥³¥ó¥Ü¤¬¥ê¥»¥Ã¥È£¨¥ì¥Ù¥ë¤ÏÉÏ•N¤·¤Ê¤¤£©", i.createElement("br", null), i.createElement("br", null), "?”³¤Ë´¥¤Ã¤Æ¤â¥Ú¥Ê¥ë¥Æ¥£¤Ê¤·", i.createElement("br", null), i.createElement("h2", null, t, "¡¡²Ù×÷¡¡", t), i.createElement("h3", null, n, " ¥Þ¥¦¥¹?¥¿¥Ã¥Á¥Ñ¥Í¥ë£¨ÍÆŠX£©"), i.createElement("div", {
            className: "border"
        }, "?¥É¥é¥Ã¥°?¥Õ¥ê¥Ã¥¯¤ÇÒÆ„Ó£«¥·¥ç¥Ã¥È", i.createElement("br", null), "?iPhone, iPad ¤Ç¤Ï ", r, " ¥Ü¥¿¥ó¤«¤é¡¸¥Û©`¥à»­Ãæ¤Ë×·¼Ó¡¹¤·¤Æ¥×¥ì¥¤¤¹¤ë¤È¿ìßm¤Ë¥×¥ì¥¤¤Ç¤­¤Þ¤¹"), i.createElement("h3", null, n, " ¥­©`¥Ü©`¥É"), i.createElement("div", {
            className: "border"
        }, "‰ä¸ü¤Ï¤Ç¤­¤Þ¤»¤ó", i.createElement("hr", null), "?¥«©`¥½¥ë¥­©`¤ÇÒÆ„Ó", i.createElement("br", null), "?£Ú¤Ç¥·¥ç¥Ã¥È", i.createElement("br", null), "?£Ó£È£É£Æ£Ô¤ÇµÍËÙÒÆ„Ó"), i.createElement("h3", null, n, " ¥²©`¥à¥Ñ¥Ã¥É"), i.createElement("div", {
            className: "border"
        }, "Ê¹¤¨¤Ê¤¤¥Ñ¥Ã¥É¤¬¤¢¤ë¤«¤â¤·¤ì¤Þ¤»¤ó", i.createElement("hr", null), i.createElement("img", {
            src: "./manual/gamepad.svg"
        })), i.createElement("h2", null, t, "¡¡¤½¤Î¤¿¡¡", t), "?»­Ãæºá·ù¤¬×ã¤ê¤Ê¤¤¤È99ÈË±íÊ¾¤Ç¤­¤Þ¤»¤ó", i.createElement("br", null), "?²ÐÄî¤Ê¤¬¤éÈËÍ¬Ê¿¤ÎŒ‘é¤Ïég¤ËºÏ¤ï¤º", i.createElement("br", null), "?¤Ê¤Ë¤«¤¹¤ë¤È¡¢ ", n, "¤Ò¤é¤Î¤ó", n, " ¤âÊ¹¤¨¤ë", i.createElement("br", null)))
    }
    function d(e) {
    ...
    function h(e) {
        ...
        S = w ? i.createElement(i.Fragment, null, i.createElement("div", {
            ...
            onClick: E
        }, "¨‹ ¤È¤¸¤ë ¨‹"), i.createElement(c, null), i.createElement("div", {
            className: "toggle-button",
            onClick: E
        }, "¡ø ¤È¤¸¤ë ¡ø")) : i.createElement("div", {
            className: "toggle-button",
            onClick: E
        }, "¤¢¤½¤Ó¤«¤¿");
        let k = {
        ...
        if (s()) {
            ...
            ;
            D = i.createElement(i.Fragment, null, i.createElement("h2", null, "? Ëû¥×¥ì¥¤¥ä©`¤Î±íÊ¾£¨¤Ä¤è¤Ä¤èPCÒÔÍâ¤Ç¤Ï¡¸¥·¥ó¥×¥ë¡¹¤òßx’k¤·¤Æ¤Í£©"), i.createElement(f, {
                activeIndex: l,
                labels: t,
                select: n
            }))
        ...
        return i.createElement("div", {
        ...
        }, T)), S, i.createElement("h2", null, "?? ÒôÉù"), i.createElement(f, {
            activeIndex: a,
            labels: ["¤¢¤ê", "¤Ê¤·"],
            select: t=>{
                e.conf.mute = 1 === t,
        ...
        }), D, i.createElement("h2", null, "? Ãè»­ég¸ô"), i.createElement(f, {
            activeIndex: h,
            labels: ["×Ô„Ó", "60FPS", "30FPS"],
            select: t=>{
                switch (t) {
                case 0:
                    e.conf.fps = 0;
        ...
        }), i.createElement("h2", null, "ÈËÊý£¨‰ˆ¤ä¤¹¤ÈÖØ¤¯¤Ê¤ë¤è£©"), i.createElement(f, {
            activeIndex: b,
            labels: o,
            select: t=>{
                e.conf.count = t + 2,
            ...
            style: k
        }, i.createElement("h2", null, "?? ¤Ò¤é¤Î¤ó"), i.createElement(f, {
            activeIndex: m,
            labels: ["£Ï£Æ£Æ", "£Ï£Î"],
            select: t=>{
                y(g + 1),
    ...
    class w {
        ...
        register() {
            ...
            this.touchm.supported || (console.log("¤Þ¤¦¤¹¤Ä¤«¤¦"),
    ...
    class P {
        ...
        checkInitialized() {
            if (null === this.ctx)
                throw new Error("initialize ¤¹¤ëÇ°¤Ë AudioManager ¤Î¥á¥½¥Ã¥É¤¬ºô¤Ð¤ì¤¿")
        }
        createGainNode() {
    ...
    function Mn(e) {
        ...
        e.game)
          ...
          , u = `${r}Î»`
          , s = `${1 === n.getPlayerID() ? "HIRANON" : "VIVIT"}-${n.getTotalPlayers()} : ${u} (${a}ÃëÉú´æ) LV${n.getComboLevel()}`
          , l = r > 1 ? `¥²©`¥à¥ª©`¥Ð©` / ${u}` : "„Ù¤Á²Ð¤ê¤Þ¤·¤¿";
        return i.createElement("div", {
    ...
    window.addEventListener("load", ()=>{
        ...
        !function(e) {
            "serviceWorker"in navigator ? navigator.serviceWorker.register("./service_worker.js").then(t=>{
                e.log("ServiceWorker ¤¬µÇåh¤µ¤ì¤Þ¤·¤¿")
            }
            ).catch(t=>{
                e.log(t.toString())
            }
            ) : e.log("ServiceWorker ¤¬µÇåh¤Ç¤­¤Þ¤»¤ó¤Ç¤·¤¿")
        }(t),
        function(e, t) {
